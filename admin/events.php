                    ...
                    <tbody>
                        <?php foreach ($pendingEvents as $event): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="events.php?approve=<?php echo $event['event_id']; ?>"
                                        class="btn btn-success btn-xs" onclick="return confirm('Approve event?');">Approve</a>
                                    ...
                                    <form method="post" id="reject-<?php echo $event['event_id']; ?>"
                                        ...
                                        <input type="text" name="reason" placeholder="Reason" required
                                            class="form-control input-sm" style="display:inline-block; width:150px;">
