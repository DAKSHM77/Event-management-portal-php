                ...
                <tbody>
                    <?php foreach ($pendingOrgs as $org): ?>
                        <tr>
                            ...
                            <td>
                                <a href="organizations.php?approve=<?php echo $org['org_id']; ?>" class="btn btn-success btn-xs"
                                    onclick="return confirm('Approve this organization?');">Approve</a>
                                <a href="organizations.php?reject=<?php echo $org['org_id']; ?>" class="btn btn-danger btn-xs"
