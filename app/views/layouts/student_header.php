...
<body>
    <header class="student-header navbar navbar-default navbar-static-top"
        style="border: 0; border-bottom: 4px solid #a5c422;">
        <div class="container">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                    data-target="#student-navbar-collapse" aria-expanded="false" style="border: 1px solid #fff;">
            ...
            <div class="collapse navbar-collapse" id="student-navbar-collapse"
                ...
                <ul class="nav navbar-nav navbar-right student-nav" style="padding: 20px 0; float: right; margin: 0;">
                    <li><a href="dashboard.php">Dashboard</a></li>
                    <li><a href="events.php">Browse Events</a></li>
                    <li><a href="my-registrations.php">My Tickets</a></li>
                    <li><a href="../logout.php"
                            style="border: 2px solid #ccc; padding: 10px 20px; border-radius: 50px; color: #fff; font-weight: 700; background: transparent; margin-top: 5px;">Logout</a>
                    </li>
                    <li><button class="theme-btn" onclick="toggleTheme()" title="Toggle Theme"
                            style="margin-top: 5px; margin-left: 10px;"><i class="fa fa-adjust"></i></button></li>
                </ul>
            </div>
        </div>
    </header>
